...
const scaleHint =
  "Use the full range. This calibrates what is reasonable to expect of an institution in your situation; it does not add to or subtract from any result.";
      ...
      fields: [
        { id: "name", label: "Institution name", type: "text", required: true },
        {
          ...
          options: [
            {
              value: "comprehensive",
              label: "Comprehensive university",
              description: "Broad disciplinary coverage across faculties",
            },
            {
              value: "technical",
              label: "Technical / engineering institution",
              description: "STEM-led with applied research focus",
            },
            {
              value: "specialist",
              label: "Specialist institution",
              description: "Single or closely related discipline set",
            },
            {
              value: "college",
              label: "Affiliated / constituent college",
              description: "Operates within a wider university system",
            },
            {
              value: "open",
              label: "Open / distance university",
              description: "Predominantly flexible or remote delivery",
            },
      ...
      fields: [
        {
          ...
          required: true,
          hint: scaleHint,
          scaleEnds: { low: "Teaching-led", high: "Research-led" },
        },
        {
          id: "studentProfileComplexity",
          label: "Student profile complexity",
          type: "scale5",
          required: true,
          hint: "Learner diversity, access and support needs across the student body.",
          scaleEnds: { low: "Homogeneous", high: "Highly diverse" },
        },
      ],
    },
    {
      ...
      fields: [
        {
          id: "aiExposure",
          label: "Degree of AI exposure",
          type: "scale5",
          required: true,
          hint: "How far AI already affects the institution's programmes, operations and decisions.",
          scaleEnds: { low: "Limited", high: "Pervasive" },
        },
        {
          id: "disciplinaryConsequence",
          label: "Disciplinary consequence",
          type: "scale5",
          required: true,
          hint: "The potential consequence of AI-driven change or AI error in the disciplines the institution teaches.",
          scaleEnds: { low: "Low", high: "Critical" },
        },
        {
          id: "trajectory",
          label: "Institutional trajectory",
          type: "scale5",
          required: true,
          hint: "The current rate of institutional change.",
          scaleEnds: { low: "Stable", high: "Rapid transformation" },
        },
      ],
    },
  ],
...
const scale = (labels: string[]): ChoiceOption[] =>
  labels.map((l) => ({
    value: l
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")
...
export const screeningPrompts: Prompt[] = [
  ...
  },
  {
    ...
    prompt:
      "When AI raises a new institutional question, how does the institution typically respond?",
    ...
    presentation: {
      ...
      provisionalOptions: true,
      options: scale([
        "Through an established institutional mechanism",
        "Through a designated committee or group",
        "Case by case, led by senior individuals",
        "Informally, where individuals take initiative",
        "Rarely addressed at institutional level",
      ]),
    },
    origin: "screening",
    allowNotSure: true,
  ...
  },
  {
    ...
    prompt:
      "How consistently is AI addressed in teaching, assessment and academic integrity practice?",
    ...
    presentation: {
      ...
      provisionalOptions: true,
      options: scale([
        "Consistently, through institution-wide guidance",
        "Broadly, with some variation by faculty",
        "Unevenly, led by individual departments",
        "Mostly by individual academics",
        "Not yet addressed",
      ]),
    },
    origin: "screening",
  ...
  },
  {
    ...
    presentation: {
      ...
      provisionalOptions: true,
      options: scale([
        "Broad, structured capability building",
        "Targeted programmes for key groups",
        "Optional or ad hoc development",
  ...
  },
  {
    ...
    prompt:
      "How readily could the institution evidence its current AI-related activity to an external reviewer?",
    ...
    presentation: {
      ...
      provisionalOptions: true,
      options: scale([
        "Readily, from existing institutional records",
        "Mostly, with some assembly required",
        "Partially, across scattered sources",
        "With difficulty",
      ]),
    },
    origin: "screening",
...
export const d03Capabilities: ChoiceOption[] = [
  ...
  {
    value: "non-technical-ai",
    label: "Discipline-relevant AI capability (non-technical disciplines)",
  },
];
...
export const domainPrompts: Record<"D01" | "D02" | "D03", Prompt[]> = {
  D01: [
    D(
      ...
      "Strategic direction",
      "d01-01",
      "How is AI currently positioned in institutional decision-making?",
      {
        kind: "single_choice",
        provisionalOptions: true,
        options: scale([
          "A stated strategic priority with senior ownership",
          "An emerging institutional priority",
          "Addressed within particular faculties or services",
      ...
      },
      {
        ...
        evidenceHints: [
          "Current strategic plan or AI strategy",
          "Council, Board or Senate papers where AI was considered",
        ],
      },
    ),
    D(
      ...
      "Strategic direction",
      "d01-02",
      "Which institutional decisions have actually changed in the last 18 months because of AI or anticipated AI-driven changes?",
      {
        kind: "records",
        ...
        fields: [
          {
            id: "area",
            label: "Area of decision",
            type: "select",
            allowOther: true,
            options: scale([
              "Programme portfolio (launch, suspend, redesign)",
              "Assessment policy or regulations",
              "Investment or budget allocation",
              "Staffing, roles or workload",
              "Technology or infrastructure",
              "Admissions or recruitment",
              "Partnerships or external relationships",
              "Research direction or priorities",
          ...
          },
          {
            ...
            type: "select",
            options: scale([
              "A new decision was taken",
              "An existing decision was reversed or stopped",
              "Priorities were re-ordered",
              "A planned decision was accelerated",
              "A planned decision was delayed",
            ]),
          },
          {
            id: "driver",
            ...
            type: "multi_select",
            options: scale([
              "Observed AI capability",
              "Anticipated AI-driven change",
              "Shift in student demand",
              "Employer, regulator or accreditor expectation",
              "Integrity or risk concern",
              "Cost or efficiency",
            ]),
          },
          ...
          { id: "when", label: "When", type: "period" },
          {
            ...
            maxLength: 120,
            optional: true,
            placeholder: "e.g. Suspended 2026 intake to BA Translation",
          },
        ],
      },
      {
    ...
    D(
      ...
      "Foresight",
      "d01-03",
      "Which assumptions underlying the current institutional model could be materially affected by AI in the next 3–5 years?",
      {
        kind: "ranked_list",
        count: 5,
        ...
        itemFields: [
          ...
          {
            id: "response",
            label: "Institutional response so far",
            type: "select",
            options: scale([
              "Not yet considered",
              "Under discussion",
    ...
    D(
      ...
      "Foresight",
      "d01-04",
      "When a significant external change is detected, what normally happens from detection to institutional action?",
      {
        kind: "process_steps",
        stepLabel: "Step",
        min: 2,
        ...
        stepFields: [
          {
            ...
            allowOther: true,
            options: scale([
              "Change noticed by individuals",
              "Raised informally with senior colleagues",
              "Formal horizon-scan or foresight report",
              "Discussed at a committee",
              "Analysis or options paper prepared",
              "Consultation with faculties or services",
              "Decision by executive or committee",
              "Resources allocated",
              "Action implemented",
              "Action reviewed",
            ]),
      ...
      },
      {
        ...
        evidenceHints: [
          "A documented foresight, horizon-scanning or scenario process, if one exists",
        ],
      },
    ),
    D(
      "D01",
      "Experimentation & resourcing",
      "d01-05",
      "How many AI pilots were conducted, evaluated, scaled or stopped in the last 24 months?",
      {
        kind: "numbers",
        ...
        fields: [
          ...
          {
            id: "evaluated",
            label: "Pilots formally evaluated",
            hint: "Cannot exceed pilots conducted",
          },
    ...
    D(
      ...
      "d01-06",
      "A major AI development threatens a major programme within three years. What would the institution do first, who initiates it, and through what mechanism?",
      {
        ...
        fields: [
          {
            id: "first",
            label: "What would the institution do first?",
            type: "select",
            allowOther: true,
            options: scale([
              "Commission a rapid review of the programme",
              "Convene an executive or task group",
              "Escalate to Council / Board",
              "Begin redesigning the programme",
              "Suspend or reduce intake",
              "Seek external or industry advice",
              "Wait for clearer evidence before acting",
              "No established response — it would depend on individuals",
            ]),
          },
          {
            id: "who",
            label: "Who initiates it?",
            type: "multi_select",
            allowOther: true,
            max: 3,
            options: actors,
          ...
          {
            id: "mechanism",
            label: "Through what mechanism?",
            type: "multi_select",
            allowOther: true,
            options: scale([
              "Existing strategic planning cycle",
              "Programme review or re-approval process",
              "Dedicated AI or futures committee",
              "Executive decision",
              "Ad hoc or emergency task group",
              "Faculty-level decision",
              "Informal senior discussion",
            ]),
          },
          {
            id: "nuance",
            label: "Anything that would change this answer",
            type: "short_text",
            maxLength: 160,
            optional: true,
            placeholder: "e.g. Depends on whether the programme is accredited",
          },
        ],
      },
      {
    ...
    D(
      ...
      "Leadership & differentiation",
      "d01-07",
      "What distinctive institutional value does the university intend to strengthen as AI makes information and routine content increasingly abundant?",
      {
        kind: "structured_form",
        provisionalOptions: true,
        fields: [
          {
            id: "value",
            label: "The value the institution intends to strengthen",
            ...
            options: scale([
              ...
              "Disciplinary depth and expertise",
              "Original research and knowledge creation",
              "Mentorship and personal academic relationships",
              "Practical, professional and experiential learning",
              "Community, civic and regional contribution",
              "Ethical and responsible leadership",
              "Interdisciplinary, problem-focused learning",
              "Trusted credentials and assessment integrity",
              "Access and inclusion",
            ]),
          },
          {
            id: "demonstrated",
            label: "Where this is already visible in practice",
            type: "multi_select",
            options: scale([
              "Named in strategy or positioning",
              "Programme design",
              "Assessment design",
              "Resource allocation",
              "Staff recruitment or development",
              "External recognition or partnerships",
              "Not yet visibly demonstrated",
            ]),
          },
          {
            id: "rationale",
            label: "Why this value — in one sentence",
            type: "short_text",
            maxLength: 200,
            optional: true,
            placeholder: "The institutional reasoning, in your own words",
          },
        ],
      },
      {
  ...
  D02: [
    D(
      ...
      "d02-01",
      "A new AI system processing student information is proposed. Who can authorise institutional deployment?",
      {
        kind: "structured_form",
        provisionalOptions: true,
        fields: [
          {
            id: "who",
            label: "Who can authorise deployment?",
            type: "multi_select",
            allowOther: true,
            max: 3,
            options: actors,
          ...
          {
            id: "basis",
            label: "Where does that authority come from?",
            type: "select",
            options: scale([
              "A formal delegation schedule",
              "Committee terms of reference",
              "A policy or framework provision",
              "Established practice, not documented",
              "Not defined — decided case by case",
              "Not sure",
            ]),
          },
          {
            id: "name",
            label: "Name of the body, schedule or policy",
            type: "short_text",
            maxLength: 100,
            optional: true,
            placeholder: "e.g. Digital Governance Committee ToR, s.4",
          },
        ],
      },
      {
        evidenceHints: [
          "AI governance framework or policy",
          "Delegation schedule or committee terms of reference",
        ],
      },
    ),
    D(
      ...
      "Ownership & decision-making",
      "d02-02",
      "What steps actually occur before a consequential AI system is approved?",
      {
        kind: "process_steps",
        stepLabel: "Step",
        min: 1,
        ...
        stepFields: [
          {
            ...
            options: scale([
              ...
              "Security review",
              "Ethics review",
              "Academic or pedagogical review",
              "Procurement or contract review",
              "Equality, bias or fairness assessment",
              "Pilot or trial",
              "Committee approval",
              "Executive sign-off",
          ...
          {
            id: "consistency",
            label: "How consistently it happens",
            type: "select",
            options: consistency,
          },
        ],
    ...
    D(
      ...
      "Policy & data",
      "d02-03",
      "Which AI governance policies are approved, implemented and reviewed?",
      {
        kind: "matrix",
        provisionalOptions: true,
        rows: {
          source: "respondent_select",
          rowLabel: "Policy",
          allowOther: true,
          options: scale([
            "Responsible / ethical AI policy",
            "Generative AI in teaching & assessment guidance",
            "Academic integrity policy (AI provisions)",
            "Data protection provisions for AI",
            "AI procurement or vendor standards",
            "Research use of AI guidance",
            "Staff use of AI guidance",
            "Student use of AI guidance",
    ...
    D(
      ...
      "Policy & data",
      "d02-05",
      "For approved AI tools, how many process personal/student data and how many have undergone defined privacy/data review?",
      {
        kind: "numbers",
        precision: true,
        fields: [
          ...
          {
            id: "reviewed",
            label: "Of those, tools that have undergone a defined privacy / data review",
            hint: "Cannot exceed the number above",
          },
        ],
      },
      {
    ...
    D(
      ...
      "Integrity & oversight",
      "d02-06",
      "How does the institution determine whether student generative-AI use is appropriate?",
      {
        kind: "structured_form",
        provisionalOptions: true,
        fields: [
          {
            id: "how",
            label: "How appropriateness is determined",
            type: "multi_select",
            options: scale([
              "Institution-wide policy defines permitted use",
              "Programme or module-level rules",
              "Each assessment brief specifies permitted AI use",
              "Academic judgement, case by case",
          ...
          {
            id: "criteria",
            label: "Criteria or decision points used",
            type: "multi_select",
            options: scale([
              ...
              "Level of study",
              "Discipline norms",
              "Disclosure and attribution by the student",
              "Professional body requirements",
            ]),
          },
          {
            id: "consistency",
            label: "How consistently this is applied",
            type: "select",
            options: scale([
              "Consistently, institution-wide",
              "Broadly, with faculty variation",
              "Varies widely",
              "Not sure",
            ]),
          },
      ...
      {
        evidenceHints: [
          "Academic integrity / generative AI guidance",
          "One assessment brief showing how AI use is specified",
        ],
      },
    ),
    D(
      ...
      "Integrity & oversight",
      "d02-07",
      "For consequential AI-assisted decisions, where can a human review or override the output?",
      {
        kind: "matrix",
        provisionalOptions: true,
        rows: {
          source: "respondent_select",
          rowLabel: "Consequential AI-assisted decision",
          allowOther: true,
          options: consequentialDecisions,
        },
        columns: [
          {
            id: "reviewPoint",
            label: "Where a human reviews",
            type: "select",
            options: scale([
              "Before the output is acted on",
              "After — on appeal or complaint",
              "Sampled or periodic review",
    ...
    D(
      "D02",
      "Incidents, vendors & testing",
      "d02-04",
      "An AI system produces a harmful or discriminatory outcome affecting a student. What happens next?",
      {
        kind: "structured_form",
        provisionalOptions: true,
        fields: [
          {
            id: "occurred",
            label: "Has such an incident actually occurred?",
            type: "yes_no_unsure",
          },
          {
            id: "next",
            ...
            allowOther: true,
            options: scale([
              "Reported through a defined incident channel",
              "Reported informally to a manager",
              "System paused or withdrawn",
              "Affected student contacted and remedy offered",
              "Formal investigation opened",
              "Vendor engaged",
              "Data protection officer or regulator notified where required",
              "No defined step — handled ad hoc",
            ]),
          },
          { id: "who", label: "Who is involved?", type: "multi_select", options: actors },
          {
          ...
          {
            id: "learning",
            label: "How does the institution learn from it?",
            type: "multi_select",
            options: scale([
              "Formal incident review",
              "Change to policy or process",
              "Change to system or vendor",
              "Lessons shared institution-wide",
          ...
          {
            id: "nuance",
            label: "Anything specific to how this works here",
            type: "short_text",
            maxLength: 160,
            optional: true,
          },
    ...
    D(
      ...
      "Incidents, vendors & testing",
      "d02-08",
      "For the three most consequential external AI systems, what due diligence and monitoring has occurred?",
      {
        kind: "records",
        ...
        fields: [
          ...
          {
            id: "diligence",
            label: "Due diligence before adoption",
            type: "multi_select",
            options: scale([
              "Data protection assessment",
              "Security review",
              "Contract or terms review",
              "Bias or fairness assessment",
              "Academic or pedagogical review",
              "Reference checks with peer institutions",
              "Pilot evaluation",
              "None",
              "Not sure",
            ]),
          ...
          {
            id: "monitoring",
            label: "Monitoring since adoption",
            type: "multi_select",
            options: scale([
              "Usage monitoring",
              "Periodic performance or accuracy review",
              "Incident or complaint tracking",
              "Contract or renewal review",
              "Vendor change notices reviewed",
              "None",
              "Not sure",
            ]),
          },
    ...
    D(
      ...
      "Incidents, vendors & testing",
      "d02-09",
      "Has the institution tested its AI governance process? What changed as a result?",
      {
        kind: "single_choice",
        provisionalOptions: true,
        options: [
          ...
          {
            value: "tested-unchanged",
            label: "Yes — tested; no changes were considered necessary",
          },
          { value: "planned", label: "Not yet, but a test is planned" },
          { value: "no", label: "No" },
        ],
        nuance: {
          label: "What was tested and what changed",
          maxLength: 160,
          placeholder:
            "e.g. Tabletop exercise on a biased admissions model; added a pre-deployment fairness check",
        },
      },
      {
  ...
  D03: [
    D(
      ...
      "d03-01",
      "Which graduate capabilities does the institution explicitly intend students to develop in the AI era?",
      {
        kind: "multi_choice",
    ...
    D(
      ...
      "Capability architecture",
      "d03-02",
      "For representative programmes, where is each selected capability intended, developed, demonstrated and assessed?",
      {
        kind: "matrix",
    ...
    D(
      ...
      "d03-03",
      "Provide one representative student activity/work sample demonstrating each of 3–5 selected capabilities.",
      {
        kind: "evidence_request",
        items: [
          "One representative student activity or work sample for each of 3–5 of the capabilities you selected",
        ],
        note: "Add these through the Evidence workspace. Anonymised samples are acceptable.",
        noteField: {
          label: "Which capabilities the samples will cover",
          maxLength: 120,
          placeholder: "e.g. Critical thinking, verification, problem formulation",
        },
      },
      {
        allowNotSure: false,
    ...
    D(
      ...
      "Demonstration & assessment",
      "d03-04",
      "How are students required to demonstrate capability rather than simply produce an answer?",
      {
        kind: "matrix",
        provisionalOptions: true,
        rows: { source: "prior_response", promptId: "d03-01", rowLabel: "Capability" },
        columns: [
          {
            id: "how",
            label: "How students are required to demonstrate it",
            type: "multi_select",
            options: scale([
              "Oral defence or viva",
              "Showing working or process documentation",
              "Reflective commentary",
              "Live or in-class performance",
              "Iterative drafts with feedback",
              "Application to a novel case",
              "Team work with individual accountability",
              "Practical, lab or placement",
    ...
    D(
      ...
      "d03-05",
      "Where are students expected to verify, challenge or contextualise AI-generated output?",
      {
        kind: "records",
        ...
        fields: [
          {
            ...
            options: scale([
              ...
              "Specific programmes",
              "Specific modules",
              "Co-curricular or skills programme",
            ]),
          },
          {
            id: "name",
            label: "Programme, module or activity name",
            type: "short_text",
            maxLength: 80,
            optional: true,
          },
          {
            id: "what",
            label: "What students are required to do",
            type: "multi_select",
            options: scale([
              "Verify factual accuracy against sources",
              "Identify errors, gaps or bias",
              "Compare with their own reasoning",
              "Improve or refine the output",
              "Contextualise for the discipline or local setting",
              "Justify acceptance or rejection",
    ...
    D(
      ...
      "Verification & problem formulation",
      "d03-06",
      "How often do students work on unfamiliar or ambiguous problems with no single prepared answer?",
      {
        kind: "single_choice",
        provisionalOptions: true,
        options: scale([
          "In most programmes, as a designed feature",
          "In many programmes",
          "In some programmes or modules",
          "Occasionally, depending on the academic",
          "Rarely",
        ]),
      },
      {
    ...
    D(
      ...
      "d03-07",
      "Where available, what proportion of students meet defined competency thresholds for selected capabilities?",
      {
        kind: "numbers",
        precision: true,
        fields: [
          {
            id: "proportion",
            label: "Proportion of students meeting defined thresholds (%)",
            hint: "For the capabilities where a threshold is defined and measured",
          },
        ],
      },
      {
    ...
    D(
      ...
      "Outcomes & disciplines",
      "d03-08",
      "For non-technical disciplines, how are students developing AI capability relevant to their discipline?",
      {
        kind: "matrix",
        provisionalOptions: true,
        rows: {
          source: "respondent_select",
          rowLabel: "Non-technical discipline",
          allowOther: true,
          options: scale([
            "Humanities",
            "Social sciences",
        ...
        columns: [
          {
            id: "how",
            label: "How students develop discipline-relevant AI capability",
            type: "multi_select",
            options: scale([
              "Dedicated AI-in-discipline module",
              "Embedded in core modules",
              "Optional or elective module",
              "Co-curricular workshops",
              "Individual academic initiative",
              "Not yet",
            ]),
          },
    ...
    D(
      ...
      "d03-09",
      "Which three graduate capabilities are least convincingly demonstrated today, and what evidence led to that conclusion?",
      {
        kind: "ranked_list",
        count: 3,
        ...
        itemFields: [
          {
            id: "basis",
            label: "What led to this conclusion",
            type: "multi_select",
            options: scale([
              "Assessment results",
...
export const targetedPrompts: Record<"D01" | "D02" | "D03", Prompt[]> = {
  D01: [
    D(
      ...
      "Experimentation & resourcing",
      "d01-t-02",
      "Show the last 12–18 months of material AI/future-priority decisions and corresponding budget, people, infrastructure or leadership-time movements. Which priority received resources and what evidence shows the movement was real?",
      {
        kind: "records",
        ...
        fields: [
          {
            id: "priority",
            label: "Priority or decision",
            type: "short_text",
            maxLength: 80,
            placeholder: "e.g. Institution-wide GenAI licence and training",
          },
          {
            id: "movement",
            label: "What moved",
          ...
          {
            id: "evidence",
            label: "What shows the movement was real",
            type: "multi_select",
            options: scale([
              "Budget or finance records",
              "Appointment or HR records",
              "Committee decisions",
              "Project records",
              "Leadership agendas or diaries",
              "No record available",
            ]),
          },
        ],
  ...
  D02: [
    D(
      ...
      "Incidents, vendors & testing",
      "d02-t-02",
      "Select the three most consequential AI use cases. Show how each risk was identified, rated, treated, assigned to an owner and monitored, including residual-risk decisions.",
      {
        kind: "records",
        ...
        fields: [
          ...
          {
            id: "identified",
            label: "How the risk was identified",
            type: "select",
            options: scale([
              "Formal risk assessment",
              "Procurement or approval review",
          ...
          {
            id: "rated",
            label: "How it was rated",
            type: "select",
            options: scale(["Rated in the risk register", "Rated informally", "Not rated"]),
          },
          {
            id: "treatment",
            label: "Treatment",
          ...
          { id: "owner", label: "Owner", type: "select", allowOther: true, options: actors },
          {
            ...
            label: "Monitoring",
            type: "select",
            options: scale(["Regular review cycle", "Ad hoc", "None"]),
          },
          {
            id: "residual",
            label: "Residual-risk decision",
            type: "select",
            options: scale(["Formally accepted", "Informally accepted", "Not decided", "Not sure"]),
          },
        ],
      },
      {
  ...
  D03: [
    D(
      ...
      "Demonstration & assessment",
      "d03-t-01",
      "Give two examples of assessed student work where students had to formulate or refine the question/problem rather than merely answer a supplied prompt. How was quality judged?",
      {
        kind: "records",
        recordLabel: "Example",
        min: 2,
        ...
        fields: [
          {
            id: "task",
            label: "Task and programme",
            type: "short_text",
            maxLength: 80,
            placeholder: "e.g. Capstone inquiry project, BSc Economics",
          },
          {
            id: "formulation",
            label: "How students formulated or refined the question",
            type: "multi_select",
            allowOther: true,
            options: scale([
              "Chose their own question",
              "Refined a broad brief",
              "Reframed a supplied problem",
          ...
          {
            id: "judged",
            label: "How quality was judged",
            type: "multi_select",
            options: scale([
              "Rubric criterion for question quality",
              "Supervisor judgement",
              "Peer review",
              "Oral defence",
              "External examiner",
              "Not explicitly judged",
            ]),
          },
        ],
      },
...
export const evidenceScopes: ChoiceOption[] = [
  "Institution-wide",
  "Faculty / school",
  "Department",
  "Programme",
...
export const metricCatalogue: MetricDef[] = [
  M(
    "D01",
    1,
    "Institutional AI Awareness",
    "Strategic AI Integration",
    "Multi-select + sampled decisions",
  ),
  M(
    "D01",
    2,
    "Future-of-Institution Thinking",
    "Future Foresight Maturity",
    "Scenario + foresight mechanism + evidence",
  ),
  M("D01", 3, "Strategic Translation", "Strategic Translation Rate", "Numerical ratio + samples"),
  M(
    "D01",
    4,
    "Programme Portfolio Foresight",
    "Programme Future-Review Coverage",
    "Numerical ratio + sample quality",
  ),
  M(
    "D01",
    5,
    "Institutional Value Proposition",
    "Strategic Differentiation Clarity",
  ...
  M(
    ...
    "Academic Integrity Governance",
    "Scenario + guidance + assessment sample",
  ),
  ...
  M(
    "D03",
    14,
    "Ethical/Social Judgement",
    "Ethical/Social Judgement",
    "Case/professional evidence",
  ),
  ...
  M(
    "D03",
    17,
    "Non-Technical Discipline AI Capability",
    "Non-Technical Discipline AI Capability",
    "Discipline matrix + sample work",
  ),
];
