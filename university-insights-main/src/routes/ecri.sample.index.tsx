...
const dimensionsList = [
  {
    ...
    req: 3,
    dist: "+1",
    simpleQuestion: "Does your university regularly track what employers need and use this to guide strategy and budgets?",
  ...
  },
  {
    ...
    req: 3,
    dist: "+1",
    simpleQuestion: "How actively does your university collaborate with industry partners, advisory boards, and corporate recruiters?",
  ...
  },
  {
    ...
    req: 4,
    dist: "0",
    simpleQuestion: "Are course syllabi co-designed with industry experts to reflect modern technologies and skills?",
    ...
    evidenceExamples: ["Board of Studies curriculum approval records with industry signatures", "Recent syllabus updates reflecting emerging tools", "Industry co-designed module course outlines", "Annual curriculum review cycle reports"]
  },
  {
    code: "D04",
    ...
    req: 4,
    dist: "+1",
    simpleQuestion: "Do all students complete mandatory, supervised, credit-bearing internships and live industry projects?",
    ...
    whatIsExamined: "Mandatory internship credit policies, student cohort coverage (>80%), industry capstone projects, employer mentor feedback, and clinical rotations.",
  ...
  },
  {
    ...
    req: 3,
    dist: "0",
    simpleQuestion: "Does the university provide professional 1-on-1 career guidance, resume masterclasses, and industry mentorship?",
  ...
  },
  {
    ...
    req: 3,
    dist: "0",
    simpleQuestion: "Are critical thinking, professional communication, and modern digital tools integrated into graduation requirements?",
    ...
    whatIsExamined: "Communication mastery modules, data analytics/AI literacy for non-tech majors, design thinking workshops, and ethical leadership courses.",
    relevantMetrics: "D06-M01 to D06-M12 (12 Canonical Metrics)",
    evidenceExamples: ["Transversal skill assessment rubrics", "Digital literacy and AI tool syllabus requirements", "Student project presentations evaluation sheets", "Critical thinking course modules"]
  },
  {
    code: "D07",
    ...
    req: 4,
    dist: "0",
    simpleQuestion: "Do student evaluations use real-world industry tasks, oral defenses, and recognized micro-credentials?",
    ...
    whatIsExamined: "Performance-based evaluations, oral defenses/pitches, external industry exam moderators, embedded vendor certifications (AWS, Google, CFA).",
  ...
  },
  {
    ...
    req: 3,
    dist: "0",
    simpleQuestion: "Does the university support student startups with incubation facilities, seed funding, and founder mentoring?",
    ...
    evidenceExamples: ["TBI / Incubator facility documentation", "Student seed funding disbursement records", "List of active student startup ventures and revenue", "Patent/IP filing documentation for student/faculty projects"]
  },
  {
    code: "D09",
    ...
    req: 4,
    dist: "0",
    simpleQuestion: "How robust is the campus placement machinery in securing verified, high-quality, diversified employer offers?",
  ...
  },
  {
    ...
    req: 4,
    dist: "+1",
    simpleQuestion: "Does the university systematically track graduate career progression at 3, 5, and 10 years and engage alumni as mentors?",
  ...
  },
  {
    ...
    req: 3,
    dist: "0",
    simpleQuestion: "Does the institution conduct annual employer satisfaction audits and use data to continuously improve all programs?",
    ...
    <div className="max-w-5xl mx-auto px-6 py-10 space-y-16">
      ...
      <div className="space-y-4">
        ...
        <p className="text-base text-muted-foreground max-w-3xl leading-relaxed">
          The complete institutional intelligence package measuring graduate employability, employer demand integration,
          and career readiness capability. All sample views operate from a single canonical baseline assessment:
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Overall score 74.8, 11-dimension profile, current vs required maturity, strengths, and priority gaps.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Isolated ECRI adjudicator workspace evaluating all 132 canonical metrics and E0–E4 evidence dossiers.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Executive Intelligence, Detailed 132-Metric Diagnostic, Board Scorecard, Evidence Dossier, and Roadmap.
          </p>
        </Link>
      </div>
      ...
      <section id="what-is-ecri" className="p-8 rounded-2xl bg-card border border-border space-y-4 scroll-mt-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          The <strong>Employability & Career Readiness Index (ECRI)</strong> is an institutional diagnostic system designed to measure, validate, and accelerate the employability capabilities of universities and higher education institutions.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          ECRI goes far beyond superficial statistics like placement percentages, number of recruiters, average starting salaries, or headcounts placed. It evaluates whether the university possesses the <strong>institutional capability chain</strong> to deliver enduring, lifelong graduate career resilience.
        </p>
      </section>
      ...
      <section id="why-ecri" className="p-8 rounded-2xl bg-card border border-border space-y-4 scroll-mt-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4 pt-2">
          <div className="p-4 rounded-xl bg-muted/40 border border-border/60 space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Measures foundational capability, curriculum co-design, and pedagogical authenticity rather than volatile short-term hiring spikes.</p>
          </div>
          <div className="p-4 rounded-xl bg-muted/40 border border-border/60 space-y-1">
            <h4 className="text-xs font-bold text-foreground">Employer Co-Design Alignment</h4>
            <p className="text-xs text-muted-foreground">Quantifies real-time industry voice participation and curriculum modernization across all academic faculties.</p>
          </div>
          <div className="p-4 rounded-xl bg-muted/40 border border-border/60 space-y-1">
            <h4 className="text-xs font-bold text-foreground">Anti-Gaming Evidence Architecture</h4>
            <p className="text-xs text-muted-foreground">High maturity scores require verified operational records, meeting logs, and student participation data (E0–E4 model).</p>
          </div>
          <div className="p-4 rounded-xl bg-muted/40 border border-border/60 space-y-1">
      ...
      <section id="methodology" className="p-8 rounded-2xl bg-card border border-border space-y-8 scroll-mt-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-teal font-semibold text-xs uppercase tracking-wider">
            <Sliders className="size-4" /> Intellectual Framework
          </div>
          <h2 className="text-2xl lg:text-3xl font-serif font-bold text-foreground">ECRI Methodology</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Understanding what ECRI measures and how institutional capability is evaluated across system, practice, and outcome layers.
          </p>
        </div>

        {/* The Institutional Capability Chain */}
        <div className="p-6 rounded-xl bg-muted/30 border border-border/60 space-y-4">
          <h3 className="text-xs font-bold text-foreground uppercase tracking-wider">The Institutional Capability Chain</h3>
          <p className="text-xs text-muted-foreground">
            ECRI examines how an institution transforms labor market intelligence into verified graduate career outcomes through 11 linked capability stages:
          </p>
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-foreground uppercase tracking-wider">The Three Core ECRI Evaluation Layers</h3>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-5 rounded-xl bg-card border-2 border-teal/40 space-y-2 shadow-xs">
              ...
              <h4 className="text-sm font-bold text-foreground">Does the institution have the system?</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Evaluates approved governance policies, dedicated budget lines, assigned leadership roles, and documented operating procedures.
              </p>
            </div>
            <div className="p-5 rounded-xl bg-card border-2 border-teal/40 space-y-2 shadow-xs">
              <span className="text-xs font-mono font-bold text-teal">02 — IMPLEMENTATION</span>
              <h4 className="text-sm font-bold text-foreground">Does the system actually operate in practice?</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Evaluates execution across all faculties, student cohort coverage (&gt;80%), active advisory boards, and authentic curriculum modernization.
              </p>
            </div>
            <div className="p-5 rounded-xl bg-card border-2 border-teal/40 space-y-2 shadow-xs">
              <span className="text-xs font-mono font-bold text-teal">03 — OUTCOME</span>
              <h4 className="text-sm font-bold text-foreground">Does it produce meaningful outcomes?</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Evaluates employer satisfaction indices, verified placement ledgers, median salary trajectories, and longitudinal alumni career mobility.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-foreground uppercase tracking-wider">The 0–5 Capability Maturity Model</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5">
            {[
              { level: "0", label: "Absent", desc: "The capability is not in place." },
              { level: "1", label: "Isolated", desc: "Exists only in individual or limited areas." },
              { level: "2", label: "Selected", desc: "Operates in some areas but not consistently." },
              { level: "3", label: "Repeatable", desc: "Defined, owned and operating across full scope." },
              { level: "4", label: "Integrated", desc: "Embedded in institutional systems & decisions." },
              { level: "5", label: "Adaptive", desc: "Measures, learns and continuously improves." },
            ].map((m) => (
              <div key={m.level} className="p-3.5 rounded-xl bg-muted/40 border border-border/60 text-center space-y-1">
        ...
        <div className="p-6 rounded-xl bg-muted/30 border border-border/60 space-y-3">
          <h3 className="text-xs font-bold text-foreground uppercase tracking-wider">Required Maturity & Transformation Distance</h3>
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ECRI does not simply ask whether something exists. It considers the level of capability appropriate for the institution&apos;s specific context (student size, faculties, research intensity) and calculates the precise distance between current standing and required maturity.
          </p>
        </div>

        {/* Evidence Verification Model (Instruction #9) */}
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-foreground uppercase tracking-wider">Evidence & Verification Architecture</h3>
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ECRI does not grant higher maturity simply because an institution makes a claim. Claims are corroborated alongside uploaded supporting documents and verified by independent assessors.
          </p>
          ...
          >
            {showTechnicalEvidence ? <ChevronUp className="size-3.5" /> : <ChevronDown className="size-3.5" />}
            {showTechnicalEvidence ? "Hide technical evidence model" : "View technical evidence methodology (E0–E4)"}
          </button>

          {showTechnicalEvidence && (
            <div className="p-4 rounded-xl bg-card border border-border space-y-2 text-xs">
              <p><strong>E0 — None:</strong> No supporting evidence or uncorroborated verbal assertion.</p>
              <p><strong>E1 — Low:</strong> Isolated departmental statement or unverified draft.</p>
              <p><strong>E2 — Moderate:</strong> Formal approved policy or institutional guideline.</p>
              <p><strong>E3 — High:</strong> Triangulated evidence: approved policy + operational meeting records + student participation data.</p>
              <p><strong>E4 — Audited:</strong> Independently audited outcomes with longitudinal data and external stakeholder corroboration.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section id="dimensions" className="p-8 rounded-2xl bg-card border border-border space-y-6 scroll-mt-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-teal font-semibold text-xs uppercase tracking-wider">
          ...
          <p className="text-sm text-muted-foreground">
            Explore the 11 plain-language dimensions evaluated across the institution. Click any dimension to inspect what is examined and sample evidence.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isExpanded ? "bg-card border-teal/50 shadow-sm" : "bg-muted/20 border-border/60 hover:border-border"
                )}
              >
                <button
                ...
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    <div className="text-right hidden sm:block">
                      ...
                      <span className="text-[10px] text-muted-foreground block">Maturity L{d.cur}</span>
                    </div>
      ...
      <section id="how-it-works" className="p-8 rounded-2xl bg-card border border-border space-y-6 scroll-mt-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-teal font-semibold text-xs uppercase tracking-wider">
          ...
          <p className="text-sm text-muted-foreground">
            Every question is designed in plain, understandable language so faculty, career teams, and registrars can answer without jargon.
          </p>
        </div>

        {/* 4 Simple Layers Example */}
        <div className="p-6 rounded-xl bg-muted/30 border border-border/60 space-y-4">
          <h3 className="text-xs font-bold text-teal uppercase tracking-wider">Example: The 4 Simple Question Layers</h3>
          <div className="p-5 rounded-lg bg-card border border-border space-y-3 text-xs">
            <div>
              <p className="text-[10px] font-bold text-teal uppercase tracking-wider">1. QUESTION</p>
              <p className="text-sm font-bold text-foreground mt-0.5">
                Does your university have a regular process for understanding what employers currently need?
              </p>
            </div>
            <div>
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">2. WHAT ARE WE ASKING?</p>
              <p className="text-muted-foreground mt-0.5">
                Tell us how your university collects information about employer needs, who is responsible for it, and how often it is updated.
              </p>
            </div>
            <div>
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">3. WHAT TO UPLOAD</p>
              <p className="text-muted-foreground mt-0.5">
                Please upload 2–3 recent documents or records (from the last 12–24 months) showing this process is actively used.
              </p>
            </div>
            <div>
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">4. EXAMPLES</p>
              <p className="text-muted-foreground mt-0.5">
                Employer survey report, advisory board meeting notes, labour market review, or proof of a curriculum change based on employer feedback.
              </p>
            </div>
            <div className="pt-2 border-t border-border flex flex-wrap gap-2">
              <span className="px-3 py-1 rounded bg-teal/10 text-teal text-xs font-semibold">✓ Yes — Fully in place</span>
              <span className="px-3 py-1 rounded bg-muted text-muted-foreground text-xs font-medium">Partly — In some areas</span>
              <span className="px-3 py-1 rounded bg-muted text-muted-foreground text-xs font-medium">No — Not in place</span>
              <span className="px-3 py-1 rounded bg-muted text-muted-foreground text-xs font-medium">Not applicable</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="what-you-receive" className="p-8 rounded-2xl bg-card border border-border space-y-8 scroll-mt-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-teal font-semibold text-xs uppercase tracking-wider">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed max-w-3xl">
            One assessment. Multiple institutional outputs. Continuous improvement. Public institutional visibility.
          </p>
        </div>
        ...
        <div className="p-5 rounded-xl bg-muted/30 border border-border/60">
          <div className="flex flex-wrap items-center justify-between gap-2 text-center text-xs font-bold">
            {["ASSESS", "DIAGNOSE", "TRANSFORM", "DOCUMENT", "REPORT", "PUBLISH", "REASSESS", "COMPARE"].map((step, sIdx) => (
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            { num: "01", title: "Executive Intelligence", desc: "Know exactly where the institution stands with high-level scores, percentile rank, and capability benchmarks.", icon: BarChart3 },
            { num: "02", title: "132-Metric Diagnostic", desc: "Understand what is driving every result across all 11 dimensions and 132 canonical metric constructs.", icon: Layers },
            { num: "03", title: "Transformation Roadmap", desc: "Know what to improve and what to do next with prescribed 90-day, 12-month, and 24-month action steps.", icon: TrendingUp },
            { num: "04", title: "Public ECRI Institutional Profile", desc: "Publish the certified institutional profile directly on the university website to attract students & recruiters.", icon: Globe },
            { num: "05", title: "Continuous Reassessment", desc: "Improve, add evidence, and request updated evaluations over the 12-month validity period without overwriting baseline.", icon: Sliders },
            { num: "06", title: "Evidence & Verification", desc: "Understand what supports the institutional position with transparent E0–E4 audit trails and anti-gaming protection.", icon: ShieldCheck },
            { num: "07", title: "Board & Leadership Scorecard", desc: "Turn assessment findings into executive decisions with concise governance scorecards and radar balance profiles.", icon: Award },
            { num: "08", title: "Transformation Record", desc: "Track baseline → reassessment → improvement with certified year-over-year Transformation Delta reporting.", icon: CheckCircle2 },
          ].map((card) => {
            const Icon = card.icon;
            return (
              <div key={card.num} className="p-5 rounded-xl bg-card border border-border/80 hover:border-teal/50 transition-all space-y-2">
