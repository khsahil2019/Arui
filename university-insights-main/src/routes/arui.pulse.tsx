...
export const Route = createFileRoute("/arui/pulse")({
  ...
  head: () => ({
    meta: [
      { title: "ARUI Institutional Pulse — Signals & Sentiment" },
      {
        name: "description",
        content:
          "A short set of strategic signals that give the ARUI assessment an early read of how AI is positioned, governed and practised across the institution.",
      },
    ],
  }),
  component: AruiPulsePage,
});

function AruiPulsePage() {
    ...
    return (
      <PageContainer width="narrow">
        <div className="mx-auto max-w-2xl py-10 text-center">
          <p className="eyebrow mt-4">Institutional AI Pulse</p>
          <h1 className="mt-3 text-3xl font-serif">Assessment Ready</h1>
          <p className="mx-auto mt-4 max-w-lg text-[15px] leading-relaxed text-muted-foreground">
            No preliminary screening signals required for this cycle. You can proceed directly to the full institutional domain assessment.
          </p>
          <div className="mt-8">
            <Button
              asChild
