...
const ecriDimensionsData = [
  ...
  },
  {
    ...
    sampleMaturity: 4,
    level: "Established",
    desc: "Institutional capability taxonomy, learning outcomes, and graduate attribute articulation.",
    strengths: [
      "Clearly articulated institutional graduate attributes embedded in course syllabi.",
      "Formal mapping of course learning outcomes (CLOs) to employability competencies.",
    ],
    gaps: [
      "Assessment rubrics do not consistently evaluate transversal and human capabilities.",
      "Lack of student-facing capability progress dashboards across degree stages.",
    ],
    implications:
      "Institute transparent capability transcripts enabling students to articulate demonstrated skills to prospective employers.",
  },
  {
    code: "D03",
    ...
    sampleMaturity: 4,
    level: "Established",
    desc: "Structured industry advisory boards, syllabus co-creation, and modular course design.",
    strengths: [
  ...
  },
  {
    ...
    sampleMaturity: 4,
    level: "Established",
    desc: "Leadership, critical enquiry, teamwork, ethical reasoning, and executive presence.",
    strengths: [
      "Embedded communication and negotiation modules across all second-year curricula.",
      "High student participation in inter-university problem-solving hackathons.",
    ],
    gaps: [
  ...
  },
  {
    ...
    sampleMaturity: 4,
    level: "Established",
    desc: "Digital fluency, workflow automation, modern tech toolkits, and data literacy.",
    strengths: [
      "Universal Python and data literacy foundation for all incoming undergraduate cohorts.",
      "Campus-wide access to enterprise cloud computing and AI development sandboxes.",
    ],
    gaps: [
      "Domain-specific AI workflow tools are not systematically taught in non-computer disciplines.",
      "Cybersecurity and data governance awareness is not formally assessed across faculties.",
    ],
    implications:
      "Integrate discipline-specific AI productivity toolkits into professional program capstones.",
  },
  {
    code: "D08",
    ...
    strengths: [
      "Design and Architecture faculties require comprehensive graduating portfolios.",
      "Blockchain-verified digital degree transcripts implemented for all graduating cohorts.",
    ],
    gaps: [
      "Engineering and Management graduates lack standardized digital project repositories (e.g. GitHub/GitLab).",
      "No institutional platform for employers to browse verified student project artifacts.",
    ],
    implications:
      "Standardize digital project portfolio submission as a graduation prerequisite across all professional degrees.",
  },
  {
    code: "D09",
    ...
    strengths: [
      ...
      "High employer satisfaction rating (>88%) on graduate technical competence.",
    ],
    gaps: [
      "Heavy recruitment concentration in IT services; limited representation in core manufacturing and social sector.",
      "Alumni-led recruiting roundtables are held on an ad-hoc rather than structured schedule.",
    ],
    implications:
      "Diversify employer partnerships into emerging sectors including renewable energy, healthcare tech, and public policy.",
  },
  {
    code: "D10",
    ...
    strengths: [
      ...
      "Median graduate compensation reflects a +18% premium over state university averages.",
    ],
    gaps: [
      "Lack of longitudinal tracking on 3-year salary progression and career promotions.",
      "Underemployment reporting in non-technical faculties lacks rigorous external verification.",
    ],
    implications:
      "Institute verified graduate outcome audits with independent statutory reporting and alumni career trajectory telemetry.",
  },
  {
    code: "D11",
    ...
    strengths: [
      "Active global alumni chapters across 18 metropolitan hubs.",
      "Lifelong university email and digital library access for all alumni.",
    ],
    gaps: [
      "Zero structured alumni upskilling or executive credential discounts post-graduation.",
      "No institutional research repository analyzing alumni career shifts and emerging job transitions.",
    ],
    implications:
      "Launch an Alumni Executive Reskilling Academy offering modular certifications for career pivots and leadership transitions.",
  },
];
